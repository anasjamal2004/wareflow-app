...
class SupplierTile extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 45.w,
                    decoration: BoxDecoration(
                      color: AppTheme.current.avatarBg,
                    ...
                    child: Column(
                      ...
                      children: [
                        CustomText(
                          ...
                          color: AppTheme
                              .current
                              .textPrimary, // Make sure this is a dark blue/black in your AppColors
                          fontSize: 16.sp,
              ...
              SizedBox(height: 16.h),
              Divider(color: AppTheme.current.border, height: 1, thickness: 1),
              SizedBox(height: 16.h),
  ...
  Widget _buildInfoRow(IconData icon, String text, bool isBold) {
    return Row(
      children: [
        Icon(icon, size: 18.r, color: AppTheme.current.icon),
        SizedBox(width: 12.w),
        Expanded(
          child: CustomText(
            text: text,
            color: isBold
                ...
                : AppTheme.current.textSecondary,
            fontSize: 13.sp,
